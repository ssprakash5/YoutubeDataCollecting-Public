Step1: Collecting the Data of 10 Youtube Channels from Google api and storying the collected data in MongodB.

Step2: Connecting MongodB with MySQL and storying the data into SQL form.

Step3: Answering for the Queries through pysql and building the Streamlit app to display it.
